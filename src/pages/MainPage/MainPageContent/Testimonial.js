...
export default function Testimonial() {
  ...
  return (
    ...
    <Typography  variant="h6"  component="div">
      ...
      <Box sx={{display:"flex"}}>
      <Typography variant="body2" sx={{fontSize:"large",fontWeight: 600,padding:"1em 0.3em 0em 0em"}}>
        Gopinath Damodaran
      </Typography>
        <Typography sx={{color: "darkgray",padding: "1.2em 1em 0em 0em"}}>(Long Term Investor)</Typography>
        </Box>
    </CardContent>
    </Box>
    <Box sx={{width:"48em",height:"17em",backgroundColor:"white",margin: "1em",borderRadius: "15px"}}>
    ...
    <Typography  variant="h5"  component="div">
      ...
      <Typography variant="body2" sx={{fontSize:"large",fontWeight: 600,padding: "1em 0.3em 0em 0em"}}>
        ...
        <Typography sx={{color: "darkgray",padding: "1.2em 1em 0em 0em"}}>(Equity Investor)</Typography>
        </Box>
    </CardContent>
    </Box >
    <Box sx={{width:"48em",height:"17em",backgroundColor:"white",margin: "1em",borderRadius: "15px"}}>
    ...
    <Typography  variant="h5"  component="div">
      ...
      <Typography variant="body2" sx={{fontSize:"large",fontWeight: 600,padding: "1em 0.3em 0em 0em"}}>
        ...
        <Typography sx={{color: "darkgray",padding: "1.2em 1em 0em 0em"}}>(Ace Investor)</Typography>
        </Box>
    </CardContent>
    </Box>
    </Box>
    </Box>
    <Box sx={{padding: "2em 29em 5em 28em"}}><Button  variant="outlined" sx={{height:120,width:450,color:"white",border: "1px solid white",borderRadius: "15px",'&:hover':{backgroundColor:'white',boxShadow:"none",color:"black"}}}><Box ><Box sx={{  fontSize: "large"}}>Click For More Verified Reviews</Box><Box><img src={Google} alt='GoogleImage'/></Box>
